    ...
    <div class="card-deck">
        <div class="card h1-00 mt-4 rounded shadow-lg border-0"  data-aos="fade-right" data-aos-duration="1600">
            ...
            <div class="card-footer bg-white border-0">
                <router-link to="/animation"><a class="btn btn-success mb-3 btn-sm">
                    See More
                </a></router-link>
            </div>
        </div>
        ...
        <div class="card mt-4 rounded shadow-lg border-0"  data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="card-footer bg-white border-0">
                <router-link to="/illustrator"><a class="btn btn-success mb-3 btn-sm">
                    See More
                </a></router-link>
            </div>
        </div>
         ...
         <div class="card mt-4 rounded shadow-lg border-0"  data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="card-footer bg-white border-0">
                <router-link to="/digital-arts"><a class="btn btn-success btn-sm mb-3">
                    See More
                </a></router-link>
            </div>
        </div>
        ...
        <div class="card mt-4 rounded shadow-lg border-0"  data-aos="fade-right" data-aos-duration="1600">
            ...
            <div class="card-footer bg-white border-0">
                <router-link to="/graphic-design"><a class="btn btn-success mb-3 btn-sm">
                    See More
                </a></router-link>
            </div>
        </div>
