...
export default {
  ...
  { id: 16, number: "16", name: "LOLA AMOUR", image: "../images/gallery/Poster/art (6).png", description: "Photoshop used to make colors pop a bit." },
  ...
  { id: 32, number: "32", name: "UNITY IN DIVERSITY", image: "../images/gallery/Poster/art (25).png", description: "A Photoshop polish on the colors." },
  ...
  { id: 37, number: "37", name: "PHP MANIPULATION COMMISSION", image: "../images/gallery/Poster/art (30).png", description: "Colors improved with Photoshop." },
  ...
  { id: 41, number: "42", name: "MAID SAMA", image: "../images/gallery/Poster/art (35).png", description: "Basic Photoshop edits to improve colors." },
  ...
  { id: 45, number: "46", name: "MURAL PAINTING CONTEST 2", image: "../images/gallery/Poster/art (39).png", description: "A Photoshop touch to fix colors." },
  { id: 46, number: "47", name: "PMN NIGHT", image: "../images/gallery/Poster/art (40).png", description: "Simple edits done using Photoshop." },
  { id: 47, number: "48", name: "ALIGHT SOLUTIONS BRANDING 2", image: "../images/gallery/Poster/art (42).png", description: "Photoshop helped smooth colors." },
  ...
  { id: 57, number: "58", name: "BORDER 9", image: "../images/gallery/Poster/art (52).png", description: "Photoshop improved the colors." },
  ...
  { id: 62, number: "63", name: "KALAWENYOUTH 3", image: "../images/gallery/Poster/art (57).png", description: "Photoshop used to brighten colors." },
  { id: 63, number: "64", name: "BORDER 10", image: "../images/gallery/Poster/art (58).png", description: "A simple Photoshop brushwork design." },
  { id: 64, number: "65", name: "1ST YEAR ACT", image: "../images/gallery/Poster/art (59).png", description: "Photoshop edits for clearer focus." },
  { id: 65, number: "66", name: "1ST YEAR ACT", image: "../images/gallery/Poster/art (60).png", description: "A Photoshop design with nice textures." },
  { id: 66, number: "67", name: "BORDER 11", image: "../images/gallery/Poster/art (61).png", description: "Smooth colors thanks to Photoshop." },
  { id: 67, number: "68", name: "TRANSNENE GREEN", image: "../images/gallery/Poster/art (62).png", description: "Layers combined in Photoshop for effect." },
   { id: 68, number: "70", name: "WOMENS VOLLEYBALL", image: "../images/gallery/Poster/art (65).png", description: "Balanced colors improved in Photoshop." },
